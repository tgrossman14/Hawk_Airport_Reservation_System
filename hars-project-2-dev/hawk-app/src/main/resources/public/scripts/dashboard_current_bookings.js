async function get_current_bookings(){
	...
	// OLD
    let position = document.querySelector('#current_bookings > tbody')
    let tr = document.createElement('tr')
	let i = 0
    for (reservation of response){
		position.append(tr)
		let value_position = document.querySelector('tbody > tr')
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = departure_date
		value_position.append(th)
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = departure_time
		value_position.append(th)
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = arrival_time
		value_position.append(th)
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = number
		value_position.append(th)
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = departure_iata
		value_position.append(th)
		var th = document.createElement('th').setAttribute('scope', 'col')
		th.innerText = arrival_iata
		value_position.append(th)
		}
    rowfade()
}
